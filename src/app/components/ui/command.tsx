...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "bg-[#121011] text-[#fafafa] border border-[#201e1f] flex h-full w-full flex-col overflow-hidden rounded-xl",
        className,
      )}
      {...props}
    />
...
function CommandInput({
  ...
  return (
    <div
      ...
      className="flex h-[52px] items-center gap-3 border-b border-white/[0.07] px-4"
    >
      <SearchIcon className="size-4 shrink-0 text-[#8d898a]" />
...
function CommandEmpty({
  ...
  return (
    <CommandPrimitive.Empty
      ...
      className="py-6 text-center text-[14px] text-[#8d898a]"
      {...props}
    />
  );
}
...
function CommandSeparator({
  ...
  return (
    <CommandPrimitive.Separator
      ...
      className={cn("bg-white/[0.07] -mx-1 h-px", className)}
      {...props}
    />
  );
}
...
function CommandShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "text-[#8d898a] ml-auto text-xs tracking-widest",
        className,
      )}
      {...props}
    />
